...
class card extends Component {
  ...
  render(){
    ...
    return(
      <Card style={{'box-shadow':'rgb(0,0,0) 10px -10px 0px -3px, rgb(254, 80, 161) 10px -10px , rgb(254, 80, 161,0.5) 0px 0px 44px 3px ',
      'outline': 'rgb(255,20,147) solid 2px'}} onClick={onClick} >
      <Image src={img} />
