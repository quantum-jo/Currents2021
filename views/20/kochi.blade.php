...
body {
	...
	background-image: url("{{ asset('https://currents.nitt.edu/images/or-kochi-bg.jpeg') }}");
	...
	<div class="wrapper">
		<nav>
			<ul>
				...
				<li><a href="https://www.facebook.com/currentsnitt" style="padding: 0; height: 100%"><img src="{{asset('https://currents.nitt.edu/images/logo-bw.png')}}"></a></li>
			</ul>
		</nav>
		<div>&nbsp;</div>
		...
		<div>
			<button style="float: right; margin-right:2%;" type="button" onclick="location='https://www.thecollegefever.com/events/volts-kochi'" class="_button tsbutton">Register Now !</button>
		</div>
		...
		<div class="content" id="grid">
			...
			<section id="content">
				...
				<p>
					<ul>
						<li>Basics of MATLAB/SIMULINK</li>
						<li>Architecture of Electric Vehicles</li>
						<li>Introduction to BLDC motor and power electronic controllers</li>
						<li>Modelling and simulation of Electric Vehicle</li>
					</ul>
				</p>
				<p>
					Participants would be able to:
					<ul>
						<li>Understand the architecture of Electric Vehicles</li>
						<li>Learn the working of BLDC motor and controllers</li>
						<li>Perform the simulation of Electric vehicles</li>
						<li>Learn the concepts of Battery management system</li>
					</ul>
				</p>
			</section>
			<section id="details">
				...
				<ul style="display: inline-block;">
					<li>DATE: 31st January 2020</li>
					<li>DURATION: 1 Day </li>
					<li>VENUE:<br>
						Toc H Institute Of Science And Technology,<br>
						Near St.George church, Arakkunnam,<br>
						Kochi, Kerala 682313<br>
					</li>
					<li>TIMINGS: 9:00 AM to 4:30 PM</li>
					<li>Cost of Workshop: INR 450/- for a Team</li>
					<li>A Team can consist of maximum 2 members.</li>
					<li><strong>Limited number of seats</strong></li>
				</ul>
				<span class="map_sec" style="float: right"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15721.992913219234!2d76.438216!3d9.892397!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xed42d99ab66753da!2sToc%20H%20Institute%20Of%20Science%20And%20Technology!5e0!3m2!1sen!2sin!4v1579877697953!5m2!1sen!2sin" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen=""></iframe></span>
			</section>
			<section id="rules">
				<h1>Rules</h1>
				<ul>
			...
			<section id="contact">
				<h1>Contact</h1>
				<p>Nitin Kasshyup<br>+91 99401 58850</p>
				<p>Vivek D C<br>+91 96001 33170</p>
				<p>You can also reach out to us at <a href="mailto:eee.currents@gmail.com">eee.currents@gmail.com</a></p>
			</section>
			<section id="register">
				<button onclick="location='https://www.thecollegefever.com/events/volts-kochi'" class="tsbutton">Register Now</button><noscript id="tsNoJsMsg">Javascript on your browser is not enabled.</noscript><script src="//www.townscript.com/organizer-popup-widget/townscript-organizer-widget.nocache.js" type="text/javascript"></script>
			</section>
		</div>
